                      ...
                      <tbody>
                        ...
                        <tr class="trheight">
                          ...
                          <td class="text-left"><?php $date=date_create($rows1->task_date);
                            ...
                            ?></td-->
                          <td class="text-left"> <a href="<?php echo base_url(); ?>task/view_all_task_details/<?php echo $rows1->user_id; ?>" rel="tooltip" title="View All Task Details" class="btn btn-simple btn-warning btn-icon edit"><i class="fa fa-th"></i></a></td>
                        </tr>
                        <?php $i++;  }   ?>
                      </tbody>
                    </table>
