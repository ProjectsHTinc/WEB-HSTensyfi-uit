      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-10">
               <div class="card">
                  <div class="header">
                     <h4 class="title">Create Task Master</h4>
                  </div>
                  <div class="content">
                     <form method="post" action="<?php echo base_url(); ?>task/add_circular_master" class="form-horizontal" enctype="multipart/form-data" id="circularmaster" name="circularmaster">
                        <fieldset>
                           ...
                           <table id="bootstrap-table" class="table">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="<?php echo base_url();  ?>task/edit_circular_master/<?php echo $rows->id; ?>" class="btn btn-simple btn-warning btn-icon edit">
