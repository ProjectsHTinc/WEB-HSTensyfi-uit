                           ...
                           <table id="example" class="table table-striped table-no-bordered table-hover" cellspacing="0">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $rows->trade_name; echo "--"; echo $rows->batch_name; ?></td>
                                    ...
                                    <td>
                                       <a href="<?php echo base_url(); ?>admission/edit_stu_details/<?php echo $rows->admission_id; ?>" rel="tooltip" title="View Admission Details " class="btn btn-simple btn-info btn-icon table-action view" href="javascript:void(0)">
