...
<div class="col-md-10">
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD79f4g1cuT6teKfopSTGYBs1-wMm4v4DY&libraries=geometry"></script>
    ...
    var stopsCollection = [<?php echo $lats; ?>];
...
function Tour_startUp(stopsCollection) {
    if (!window.tour) window.tour = {
        ...
        loadMap: function (map, directionsDisplay) {
            var myOptions = {
                zoom: 13,
                center: new window.google.maps.LatLng(11.00736225, 77.01511127), // default to London
        ...
        calcRoute: function (directionsService, directionsDisplay, stops) {
            var batches = [];
            var itemsPerBatch = 24; // google API max = 10 - 1 start, 1 stop, and 8 waypoints
            var itemsCounter = 0;
...
if (!window.tour) window.tour = {
  ...
  loadMap: function (map, directionsDisplay) {
      var myOptions = {
          zoom: 13,
          center: new window.google.maps.LatLng(11.004556, 76.961632), // default to London
...
icons[iconStr] = new google.maps.MarkerImage("http://www.google.com/mapfiles/marker.png",
// This marker is 20 pixels wide by 34 pixels tall.
new google.maps.Size(20, 34),
// The origin for this image is 0,0.
new google.maps.Point(0,0),
