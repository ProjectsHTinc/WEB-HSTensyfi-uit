            ...
            <div class="card">
                ...
                <?php if($this->session->flashdata('msg')): ?>
                    ...
                    <?php foreach($result as $rows) ?>
                        <div class="content">
                            <form method="post" action="<?php echo base_url(); ?>tradematerial/save_trade_material" class="form-horizontal" enctype="multipart/form-data" id="materialform" name="materialform">
                              ...
                              <fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="trade_title" id="trade_title" class="form-control" value="<?php echo $rows->trade_title; ?>">
...
<?php  } ?></span>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-info btn-fill center">Update Material </button>
                                        </div>
