        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <?php if($this->session->flashdata('msg')): ?>
                    ...
                    <?php endif; ?>
                        <div class="content">
                            <form method="post" action="<?php echo base_url(); ?>tradematerial/create" class="form-horizontal" enctype="multipart/form-data" id="materialform">

                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Select Trade</label>
                                        <div class="col-sm-4">
                                            <select name="trade_id" class="selectpicker form-control" data-title="Select Trade" data-style="btn-default btn-block" data-menu-style="dropdown-blue">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="trade_title" id="trade_title" class="form-control">
