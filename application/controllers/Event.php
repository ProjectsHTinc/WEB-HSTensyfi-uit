...
class Event extends CI_Controller
{
	...
	public function add()
	{
		...
		// /echo $event_status;exit;
		$datas=$this->eventmodel->create_event($event_date,$event_name,$event_details,$event_status,$trade_batch,$user_id);
	...
	public function save()
	{
		...
		$trade_batch=$this->input->post('trade_batch');
		$event_status=$this->input->post('event_status');
		$datas=$this->eventmodel->save_event($event_id,$event_date,$event_name,$event_details,$event_status,$trade_batch,$user_id);
		if($datas['status']=="success"){
